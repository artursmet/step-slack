...
export COLOR="good"
if [ -n "$WERCKER_SLACK_NOTIFIER_CUSTOM_SUCCESS_MESSAGE" ]; then
  export MESSAGE=$WERCKER_SLACK_NOTIFIER_CUSTOM_SUCCESS_MESSAGE
  export FALLBACK=$WERCKER_SLACK_NOTIFIER_CUSTOM_SUCCESS_MESSAGE
fi
...
if [ "$WERCKER_RESULT" = "failed" ]; then
  ...
  export COLOR="danger"
  if [ -n "$WERCKER_SLACK_NOTIFIER_CUSTOM_FAIL_MESSAGE" ]; then
    export MESSAGE=$WERCKER_SLACK_NOTIFIER_CUSTOM_FAIL_MESSAGE
    export FALLBACK=$WERCKER_SLACK_NOTIFIER_CUSTOM_FAIL_MESSAGE
  fi
fi
